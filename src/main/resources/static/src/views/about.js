    ...
    template: `
      <div>
        ...
        <div class="about-section">
          <h2>Auctionista</h2>
          <p>Det kostar inget att prova Auctionista, du betalar bara när du har fått något sålt!</p>
        </div>

        <h2 style="text-align:center">Vår team</h2>
        <div class="about-row">
          <div class="about-column">
            <div class="about-card">
              <img src="/src/assets/eva.jpg" alt="Eva">
          ...
          <div class="about-column">
            <div class="about-card">
              <img src="/src/assets/ralf.jpg" alt="Ralf">
              <div class="about-container">
                <h2>Ralf Holm</h2>
          ...
          <div class="about-column">
            <div class="about-card">
              <img src="/src/assets/magnus.jpg" alt="Magnus">
              <div class="about-container">
          ...
          <div class="about-row">
            ...
            <div class="about-column"> 
              ...
              <p class="mk-box-icon-2-content"><span style="color: #ffffff;"><b>Kundtjänst e-post</b></span><br><br>
                <span style="color: #ffffff;"> <a style="color: #ffffff;" href="mailto:info@auctionist.se">info@auctionist.se</a></span>
              </p>
            </div>
          </div>
        </div>
